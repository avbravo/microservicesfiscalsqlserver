 ...
 */
@Stateless
public class TClientesRepository extends Repository<TClientes> {

    @Inject
    Connection connection;
    String tablename="Tclientes";

    public TClientesRepository() {
        super(TClientes.class, "database");
    }
...
//    }
    ...
    public List<TClientes> findAll() {
        ...
        try {
            ...
            BeanListHandler<TClientes> beanListHandler
