...
import com.avbravo.microservicesfiscalsqlserver.sql.tables.TFactura;
 ...
 */
@Stateless
public class TFacturaRepository extends Repository<TFactura> {

    @Inject
    Connection connection;
    String tablename="Tfactura";

    public TFacturaRepository() {
        super(TFactura.class, "database");
    }
...
//    }
    ...
    public List<TFactura> findAll() {
        List<TFactura> list = new ArrayList<>();

        try {

            BeanListHandler<TFactura> beanListHandler
                    = new BeanListHandler<>(TFactura.class);
