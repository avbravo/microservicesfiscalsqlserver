...
import com.avbravo.microservicesfiscalsqlserver.sql.entity.TPedidosEnLinea;
 ...
 */
@Stateless
public class TPedidosEnLineaRepository extends Repository<TPedidosEnLinea> {

    @Inject
    Connection connection;
    String tablename="Tpedidosenlinea";

    public TPedidosEnLineaRepository() {
        super(TPedidosEnLinea.class, "database");
    }
...
//    }
    ...
    public List<TPedidosEnLinea> findAll() {
        List<TPedidosEnLinea> list = new ArrayList<>();

        try {

            BeanListHandler<TPedidosEnLinea> beanListHandler
                    = new BeanListHandler<>(TPedidosEnLinea.class);
